...
#decoding step
$KALDI_DIR/egs/wsj/s5/steps/decode.sh --nj 6  $TRAIN_EXP_DIR/tri1/graph $DATA_DIR/dev $TRAIN_EXP_DIR/tri1/decode
...
#decoding step
$KALDI_DIR/egs/wsj/s5/steps/decode.sh --nj 6  $TRAIN_EXP_DIR/tri2a/graph $DATA_DIR/dev $TRAIN_EXP_DIR/tri2a/decode
