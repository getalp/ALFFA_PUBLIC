...
echo -e "monophones step \n"
  $KALDI_DIR/egs/wsj/s5/steps/train_mono.sh  --nj 14  data/train lang_o3g_NoLengthContrast exp/system1_NoLengthContrast/mono 
  ...
  $KALDI_DIR/egs/wsj/s5/steps/decode.sh --nj 2  exp/system1_NoLengthContrast/mono/graph data/dev exp/system1_NoLengthContrast/mono/decode_dev
  $KALDI_DIR/egs/wsj/s5/steps/decode.sh --nj 2  exp/system1_NoLengthContrast/mono/graph data/test exp/system1_NoLengthContrast/mono/decode_test
