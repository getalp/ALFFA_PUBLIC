...
# names here so be careful in case the script changes.
 #steps/nnet2/convert_nnet1_to_nnet2.sh exp/system1_NoLengthContrast/dnn4b_pretrain-dbn_dnn exp/system1_NoLengthContrast/dnn4b_nnet2
 #cp exp/system1_NoLengthContrast/tri3b/splice_opts exp/system1_NoLengthContrast/tri3b/cmvn_opts exp/system1_NoLengthContrast/tri3b/final.mat exp/system1_NoLengthContrast/dnn4b_nnet2/
# 
  #steps/nnet2/decode.sh --nj 10 --cmd "$decode_cmd" --transform-dir exp/system1_NoLengthContrast/tri3b/decode \
  #steps/nnet2/decode.sh --nj 10 --transform-dir exp/system1_NoLengthContrast/tri3b/decode \ 
  #  --config conf/decode.config exp/system1_NoLengthContrast/tri3b/graph data/dev exp/system1_NoLengthContrast/dnn4b_nnet2/decode

# decoding results are essentially the same (any small difference is probably because
# decode.config != decode_dnn.config).
# %WER 1.58 [ 198 / 12533, 22 ins, 45 del, 131 sub ] exp/system1_NoLengthContrast/dnn4b_nnet2/decode/wer_3
# %WER 1.59 [ 199 / 12533, 23 ins, 45 del, 131 sub ] exp/system1_NoLengthContrast/dnn4b_pretrain-dbn_dnn/decode/wer_3
