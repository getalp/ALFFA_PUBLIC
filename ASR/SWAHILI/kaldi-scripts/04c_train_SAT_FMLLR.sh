...
#steps/align_si.sh  --nj 4 --use-graphs true data/train lang exp/system1/tri2b exp/system1/tri2b_ali
steps/train_sat.sh 2000 20000 data/train lang exp/system1/tri2b_ali exp/system1/tri3b 
