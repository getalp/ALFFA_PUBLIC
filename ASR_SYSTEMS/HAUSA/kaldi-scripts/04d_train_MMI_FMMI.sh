...
#decoding step
$KALDI_DIR/egs/wsj/s5/steps/decode.sh --nj 6 --transform-dir $TRAIN_EXP_DIR/tri3b/decode $TRAIN_EXP_DIR/tri3b/graph $DATA_DIR/dev $TRAIN_EXP_DIR/tri3b_mmi_b0.1/decode
...
for iter in 3 4 5 6 7 8; do
 $KALDI_DIR/egs/wsj/s5/steps/decode_fmmi.sh --nj 6  --iter $iter --transform-dir  $TRAIN_EXP_DIR/tri3b/decode $TRAIN_EXP_DIR/tri3b/graph $DATA_DIR/dev $TRAIN_EXP_DIR/tri3b_fmmi_indirect/decode_it$iter
done
